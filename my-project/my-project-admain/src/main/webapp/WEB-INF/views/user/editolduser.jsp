   ...
   <jsp:include page="../includes/daohanginclude.jsp"></jsp:include>
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-head-line" style="background-color: #F2DEDE;color: black;text-align: center;padding-top: 6px">修改用户信息</h1>
                ...
                <div class="col-md-8 col-sm-8 col-xs-10">
                    <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <form action="/user/updateuser" method="post" id="forms">
                                <div class="form-group">
                                    <label id="div1">新用户名:</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input type="text" class="form-control" value="${singleuser.username}" id="rusername" name="username" maxlength="6">
                                    </div>
                                    <label id="div2">新密码:</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                        <input type="text" class="form-control" value="${singleuser.password}"  name="password" maxlength="8" id="rpassword">
                                    </div>
                                    <label id="div4">联系方式:</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-phone"></i></span>
                                        <input type="text" class="form-control" value="${singleuser.phone}" name="phone" id="phone" maxlength="11">
                                    </div>
                                    <label id="div5">邮箱地址:</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                                        <input type="text" class="form-control" value="${singleuser.email}" name="email" id="email" maxlength="20">
                                    </div>
                                    <input type="hidden" value="${singleuser.id}" name="id">
                                    <br />
                                </div>
                            </form>
                            <input type="submit" class="btn btn-info btn-sm btn-block" value="提交修改" id="tijioa"/>
                            <hr>
                        </div>
                    </div>
                </div>
